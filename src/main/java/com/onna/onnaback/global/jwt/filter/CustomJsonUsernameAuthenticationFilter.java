...
public class CustomJsonUsernameAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String DEFAULT_LOGIN_REQUEST_URL = "/api/auth"; // "/login"으로 오는 요청을 처리
    ...
    public CustomJsonUsernameAuthenticationFilter(ObjectMapper objectMapper) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException {
        ...
        UsernamePasswordAuthenticationToken authRequest = new UsernamePasswordAuthenticationToken(email,"");//principal 과 credentials 전달
